...
commodity_data = {
    "CSC": {
        ...
        "Jul-2025": ["BJQ25", 1.679, 0.000, 2.10, 0.100, -0.100, -1.0, "-2.9%", -0.100],
        "Aug-2025": ["BJU25", 1.759, 0.043, 1.87, 0.060, 0.111, 1.0, "6.3%", 0.111],
        "Sep-2025": ["BJV25", 1.903, 0.087, 1.82, 0.070, -0.083, -1.0, "-4.4%", -0.083],
        "Oct-2025": ["BJO25", 2.000, 0.090, 2.09, 0.110, 0.090, 1.0, "4.5%", 0.090],
        "Nov-2025": ["BJN25", 2.100, 0.095, 2.00, 0.080, -0.100, -1.0, "-4.8%", -0.100],
        "Dec-2025": ["BJD25", 2.200, 0.100, 2.32, 0.120, 0.120, 1.0, "5.5%", 0.120],
        "Jan-2026": ["BJF26", 2.250, 0.105, 2.15, 0.090, -0.100, -1.0, "-4.4%", -0.100],
        "Feb-2026": ["BJB26", 2.300, 0.110, 2.41, 0.130, 0.110, 1.0, "4.8%", 0.110],
        "Mar-2026": ["BJM26", 2.350, 0.115, 2.25, 0.095, -0.100, -1.0, "-4.3%", -0.100],
        "Apr-2026": ["BJA26", 2.400, 0.120, 2.51, 0.140, 0.110, 1.0, "4.6%", 0.110],
        "May-2026": ["BJK26", 2.450, 0.125, 2.34, 0.105, -0.110, -1.0, "-4.5%", -0.110],
        "Jun-2026": ["BJU26", 2.500, 0.130, 2.61, 0.150, 0.110, 1.0, "4.4%", 0.110]
    },
    "ZC": {
        "metric": [
            "Contract Code", "Current Fwd Price", "Insurance Premium",
        ...
        "Jul-2025": ["ZCQ25", 4.750, 0.100, 4.85, 0.120, 0.100, 1.0, "2.1%", 0.100],
        "Aug-2025": ["ZCU25", 4.880, 0.120, 4.78, 0.100, -0.100, -1.0, "-2.0%", -0.100],
        "Sep-2025": ["ZCV25", 4.910, 0.130, 5.01, 0.150, 0.100, 1.0, "2.0%", 0.100],
        "Oct-2025": ["ZCO25", 4.920, 0.135, 4.82, 0.115, -0.100, -1.0, "-2.0%", -0.100],
        "Nov-2025": ["ZCN25", 4.930, 0.140, 5.03, 0.160, 0.100, 1.0, "2.0%", 0.100],
        "Dec-2025": ["ZCD25", 4.940, 0.145, 4.84, 0.125, -0.100, -1.0, "-2.0%", -0.100],
        "Jan-2026": ["ZCF26", 4.950, 0.150, 5.05, 0.170, 0.100, 1.0, "2.0%", 0.100],
        "Feb-2026": ["ZCB26", 4.960, 0.155, 4.86, 0.135, -0.100, -1.0, "-2.0%", -0.100],
        "Mar-2026": ["ZCM26", 4.970, 0.160, 5.07, 0.180, 0.100, 1.0, "2.0%", 0.100],
        "Apr-2026": ["ZCA26", 4.980, 0.165, 4.88, 0.145, -0.100, -1.0, "-2.0%", -0.100],
        "May-2026": ["ZCK26", 4.990, 0.170, 5.09, 0.190, 0.100, 1.0, "2.0%", 0.100],
        "Jun-2026": ["ZCU26", 5.000, 0.175, 4.90, 0.155, -0.100, -1.0, "-2.0%", -0.100]
    }
}
